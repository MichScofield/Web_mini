...
<ul>
  <li><a class="mini_active" href="website.php">Home</a></li>
  <li><a href="mini_signup.html">Sign Up</a></li>
  <li><a href="mini_admin.html">Admin</a></li>
  <li><a href="mini_contact.html">Contact</a></li>
...
echo"<table border ='1'>";
echo "<tr><th>Flight No.</th><th>Name</th><th>Source</th><th>Destination</th><th>Fare</th></tr>";
if ($trip_class == 'economic') {
  ...
  echo "<tr><td>{$row['Id']}</td><td>{$row['Name']}</td><td>{$row['Source']}</td><td>{$row['Destination']}</td><td>{$price}</td><td><form id= \"Passing\" method=\"post\" action=\"mini_book_flight.php\">
